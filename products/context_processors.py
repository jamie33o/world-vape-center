...
def filters(request):
    ...
    This function creates an instance of the FiltersForm using the request's GET parameters.
    It is intended to be used as a context processor to make the form available in templates.
