...
class ProductVariantInline(admin.StackedInline):
    ...
    extra = 1  # Shows 1 empty variant form by default
    fields = ['image', 'additional_info', 'variant_type', 'sku', 'name', 'countInStock']
    readonly_fields = ['sku']  # If you want to make some fields read-only
...
class ProductAdmin(admin.ModelAdmin):
    ...
    inlines = [ProductVariantInline, ReviewInline]  # 👈 Add Variants inside Product Admin
