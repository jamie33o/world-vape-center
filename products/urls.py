...
for navigating through the products app.
It includes patterns for searching,
viewing categories, product details, posting
...
- product_details: Displays detailed
...
- add_to_favorites: Handles adding a
product to the user's favorites.
"""
...
urlpatterns = [
    ...
    path('post_review/<int:product_id>',
         ReviewsView.as_view(), name='post_review'),
