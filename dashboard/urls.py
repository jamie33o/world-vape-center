...
urlpatterns = [
    ...
    path('change_status/<int:order_id>', change_order_status,
         name='change_status'),
    ...
    path('change_ticket_status/<int:ticket_id>',
         change_ticket_status, name='change_ticket_status'),
    path('open_ticket/',
         open_ticket, name='open_ticket'),
